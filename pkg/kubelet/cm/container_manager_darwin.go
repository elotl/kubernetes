...
type noopDarwinResourceAllocator struct{}

func (ra *noopDarwinResourceAllocator) Admit(attrs *lifecycle.PodAdmitAttributes) lifecycle.PodAdmitResult {
...
func (cm *containerManagerImpl) GetAllocateResourcesPodAdmitHandler() lifecycle.PodAdmitHandler {
	return &noopDarwinResourceAllocator{}
}
